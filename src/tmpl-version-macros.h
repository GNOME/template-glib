...
#define TMPL_VERSION_3_42 (G_ENCODE_VERSION (3, 42))
...
#if TMPL_VERSION_MIN_REQUIRED >= TMPL_VERSION_3_42
# define TMPL_DEPRECATED_IN_3_42                TMPL_DEPRECATED
# define TMPL_DEPRECATED_IN_3_42_FOR(f)         TMPL_DEPRECATED_FOR(f)
#else
# define TMPL_DEPRECATED_IN_3_42                _TMPL_EXTERN
# define TMPL_DEPRECATED_IN_3_42_FOR(f)         _TMPL_EXTERN
#endif

#if TMPL_VERSION_MAX_ALLOWED < TMPL_VERSION_3_42
# define TMPL_AVAILABLE_IN_3_42                 TMPL_UNAVAILABLE(3, 42)
#else
# define TMPL_AVAILABLE_IN_3_42                 _TMPL_EXTERN
#endif
